...
public enum ModelDataEnum
{
	...
	//
	// modelData.set("configIds", Arrays.asList("chapterName", "countryName",
	// "stateName", "villageName", "townName", "cityName", "localityName"));
	// modelData.set("configCols", Arrays.asList("Chapter Name", "Country",
	// "State", "Village", "Town", "City", "Locality"));
	// modelData.set("configType", Arrays.asList("Text", "combo", "combo",
	...
	// modelData.set("data", list);
	// modelData.set("parentStoreChapter", DataUtil.<ModelData>
	// getModelList("ChapterName"));
	//
	...
	// try
	// {
	// List<ChapterName> lstChapterName = DataUtil.<ChapterName>
	// getRawList("ChapterName");
	// List<ModelData> lstModels = model.get("data");
	//
	// Mapper dozerMapper = HibernateUtil.getDozerMapper();
	//
	...
	//
	// hibObject.setChapterName(findParent(lstChapterName, new
	...
	// List<String> lstChapterNames =
	// (List<String>)DataUtil.executeQuery("select name from ChapterName");
	// List<String> lstProjects =
	// (List<String>)DataUtil.executeQuery("select name from Project");
	//
	...
	// Logger.getLogger(ModelDataEnum.class);
