package com.varun.yfs.client.screening.camp;
...
public class CampScreeningDetail extends LayoutContainer
{
	...
	private void validateAndSave()
	{
		...
		CampScreeningDetailDTO modelData = extractFormData();
		savePage(modelData);
	}
	...
	private CampScreeningDetailDTO extractFormData()
	{
	...
	public void initialize(String title, String scrId)
	{
		...
		detailServiceAsync.getModel(scrId, new AsyncCallback<ModelData>()
		{
			...
			public void onSuccess(ModelData modelData)
			{
				...
				CampScreeningDetailDTO scrDto = modelData.get("data");
				if (scrDto != null)
				{
	...
	private void savePage(CampScreeningDetailDTO model)
	{
